    ...
    <div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold text-dark-heading mb-6 leading-tight">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        <h2 className="text-3xl font-bold text-dark-heading text-center mb-12">
          Built for Trust
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="card text-center">
            ...
            <h3 className="text-xl font-semibold text-dark-heading mb-3">
              Escrow Payments
            </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            ...
            <div key={item.step} className="card text-center">
              ...
              <p className="text-sm text-dark-text">{item.desc}</p>
            </div>
          ))}
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={stat.label}>
                ...
                <div className="text-dark-text mt-1">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
